    ...
    <div className="relative bg-white overflow-hidden">
          ...
          <main className="mx-auto max-w-7xl">
            <div className="sm:text-center lg:text-left">
              <h1 className="text-4xl tracking-tight font-extrabold text-brand-dark sm:text-5xl md:text-6xl">
                ...
                <span className="block text-brand-blue xl:inline">Wedding Professionals</span>
              ...
              <div className="mt-8 sm:max-w-lg sm:mx-auto lg:mx-0 flex rounded-full shadow-lg border border-gray-100 bg-white p-2">
                <div className="flex-grow flex items-center pl-4 pr-2">
                  <Search className="h-5 w-5 text-brand-textSec" />
                  <input
                    type="text"
                    className="w-full pl-3 pr-3 py-2 text-gray-700 bg-transparent outline-none placeholder-gray-400"
                    placeholder="E.g. Cinematographer in Mumbai..."
                  />
                </div>
                <button className="bg-brand-blue text-brand-text rounded-full px-6 py-3 font-medium hover:bg-blue-700 transition-colors">
                  Search
                </button>
              </div>
            </div>
      ...
      <div className="lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2 bg-gray-50 flex items-center justify-center p-12">
        <div className="grid grid-cols-2 gap-4 w-full h-full max-h-[600px] opacity-80">
           <div className="bg-blue-100 rounded-3xl h-full shadow-inner animate-pulse"></div>
           <div className="bg-blue-50 rounded-3xl h-4/5 mt-auto shadow-inner animate-pulse"></div>
        </div>
      </div>
    </div>
  );
